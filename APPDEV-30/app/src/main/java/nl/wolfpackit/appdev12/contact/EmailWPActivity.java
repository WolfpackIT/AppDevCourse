    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data){
        if(requestCode==emailRequestCode){
            if(resultCode==0){ //success
                MainActivity.createSimpleNotification(MainActivity.getStringByID(R.string.mailSuccessNotifcationTitle),
                                                MainActivity.getStringByID(R.string.mailSuccessNotifcationBody));
            }else{
                MainActivity.createSimpleNotification(MainActivity.getStringByID(R.string.mailFailNotifcationTitle),
