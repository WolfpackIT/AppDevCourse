...
@android.arch.persistence.room.Database(entities = {Declaration.class, Account.class, DeclarationFeedback.class, Receipt.class, TravelDeclaration.class, News.class}, version = 17, exportSchema = false)
public abstract class Database extends RoomDatabase{
    ...
    public static void getDeclarationsBySearch(final String search, QueryResult<List<Declaration>> res){
        db.createTask(new Callable(){
            public Object call() throws Exception {
                return db.declarationDao().findBySearch("%"+search+"%");
            }
        }, res);
    }
    public static void getDeclarationsAcceptedBySearch(final String search, QueryResult<List<Declaration>> res){
        db.createTask(new Callable(){
            public Object call() throws Exception {
                return db.declarationDao().findAcceptedBySearch("%"+search+"%");
            }
        }, res);
    }
